...
/**
 * Communicates with the API and executes Handlers on incoming updates
 */
class Bot {
   ...
   *                                       should be set (is set manually
   *                                       (this.server), or by the Server
   *                                       itself by passing the Bot object to
   *                                       the Server's constructor). Leave
   *                                       blank or pass undefined if the server
