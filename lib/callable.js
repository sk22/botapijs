const camelCase = require('camelcase');
  ...
  *                              data
  * @param {Processor} processor The same as the first processor param. Can be
  *                              useful if one of the processor params are
  *                              destructed, but a method needs to be called
  *                              from the object (like processor.send)
  *
  * @see Processor
